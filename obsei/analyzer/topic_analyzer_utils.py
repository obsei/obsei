...
def c_tf_idf(documents, m, ngram_range=(1, 1)) -> Tuple[np.ndarray, CountVectorizer]:
    count: CountVectorizer = CountVectorizer(ngram_range=ngram_range, stop_words="english")
    count.fit(documents)
