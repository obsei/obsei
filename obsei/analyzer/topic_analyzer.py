...
from obsei.analyzer.topic_analyzer_utils import get_topics_by_cluster, get_umap_embedings, cluster_embeddings, get_vec_lda, Autoencoder
...
class TopicClassificationAnalyzer(BaseAnalyzer):
    ...
    def _get_lda_embeddings(self, source_input_list, num_topics= 10):
    ...
    def _get_topic_ldabert(self, source_input_list,source_name, umap_n_neighbors = 10, umap_n_components = 5,min_cluster_size = 10  ):
        ...
        umap_embeddings = get_umap_embedings(embeddings=ldabert_embeddings, n_neighbors=umap_n_neighbors,
...
if __name__ == '__main__':
    ...
    print("downld")
    topic_analyzer = TopicClassificationAnalyzer(model_name_or_path = "paraphrase-TinyBERT-L6-v2 ",method = "BERT")
